...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }: any) => {
    ...
    class App {
      ...
      loadAssets() {
        ...
        return new Promise((resolve) => {
          // modern postprocessing doesn't need manual image URLs, but keep resolve
          resolve(null);
        });
      }
      ...
      setSize(width: any, height: any, updateStyles: any = undefined) {
        if (width <= 0 || height <= 0) {
          this.hasValidSize = false;
          return;
        }
