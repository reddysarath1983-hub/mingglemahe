        ...
        {data.map((item: any, i: number) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-4">
              <h3 className="text-white text-xl font-bold">{item.name || item.alt}</h3>
              {item.course && <p className="text-white/80 text-sm">{item.course}</p>}
            </div>
            ...
            {onLike && (
               <button
                  ...
                  className="absolute top-4 right-4 bg-white/20 hover:bg-[#ff5260] backdrop-blur-md text-white p-3 rounded-full transition-colors z-50 group-hover:opacity-100 opacity-80"
                >
