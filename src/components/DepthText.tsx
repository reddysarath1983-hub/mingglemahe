...
const getLayerColor = (faceColor: any, depthColor: any, index: any, total: any) => {
...
const getTransform = (rotateX: any, rotateY: any) => `rotateX(${rotateX.toFixed(3)}deg) rotateY(${rotateY.toFixed(3)}deg)`;
